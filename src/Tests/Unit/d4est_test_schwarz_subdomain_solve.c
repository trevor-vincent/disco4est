...
int main(int argc, char *argv[])
{
  ...
  /* double* x_over_subdomains = P4EST_ALLOC(double, */
                                          /* schwarz_data->restricted_nodal_size); */
  /* double* y_over_subdomains = P4EST_ALLOC(double, */
                                          /* schwarz_data->restricted_nodal_size); */
  /* double* z_over_subdomains = P4EST_ALLOC(double, */
                                          /* schwarz_data->restricted_nodal_size);   */
  ...
  double* Au = P4EST_ALLOC_ZERO(double, local_sizes.local_nodes);
    ...
    /* DEBUG_PRINT_ARR_DBL(elliptic_data.Au, local_sizes.local_nodes); */
 ...
 d4est_solver_schwarz_convert_nodal_field_to_restricted_field_over_subdomains
  ...
  double* zero_vec_restricted_field_over_subdomain = P4EST_ALLOC(double,schwarz_data->subdomain_data[0].restricted_nodal_size);
  int restricted_nodal_size = schwarz_data->subdomain_data[0].restricted_nodal_size;
  ...
  d4est_solver_schwarz_cg_solve_subdomain_single_core
    (
     ...
     &elliptic_data,
     &prob_fcns,
     zero_vec_restricted_field_over_subdomain,
     Apoly_vec_compare_over_subdomains,
     u,
     Au,
     restricted_nodal_size,
     100,
     0
    );  
  

  DEBUG_PRINT_4ARR_DBL(poly_vec_over_subdomains, zero_vec_restricted_field_over_subdomain, Apoly_vec_over_subdomains, Apoly_vec_compare_over_subdomains, restricted_nodal_size);
  ...
  P4EST_FREE(zero_vec_restricted_field_over_subdomain);
  P4EST_FREE(u);
  P4EST_FREE(poly_vec);
