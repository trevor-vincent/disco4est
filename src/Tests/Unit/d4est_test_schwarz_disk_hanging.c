...
int main(int argc, char *argv[])
{
  ...
  sprintf(input_file, "%s", (argc == 2) ? argv[1] : "d4est_test_schwarz_disk_hanging.input");
  ...
  d4est_test_schwarz_disk_hanging_t test_hanging_input = d4est_test_schwarz_disk_hanging_input(input_file);
