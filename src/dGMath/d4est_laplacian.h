...
void d4est_laplacian_apply_stiffness_matrix(p4est_t *p4est,d4est_operators_t *d4est_ops,d4est_geometry_t *d4est_geom,d4est_quadrature_t *d4est_quad,d4est_mesh_data_t *d4est_factors,double *restrict u,double *restrict Au,int local_nodes,int which_field);
void d4est_laplacian_apply_stiffness_matrix_on_element(d4est_operators_t *d4est_ops,d4est_geometry_t *d4est_geom,d4est_quadrature_t *d4est_quad,d4est_mesh_data_t *d4est_factors,d4est_element_data_t *ed,double *restrict u_element,double *restrict Au_element);
