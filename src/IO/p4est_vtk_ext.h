#ifndef P4EST_VTK_EXT_H
#define P4EST_VTK_EXT_H 
 ...
 */
void                p4est_vtk_ext_write_file (p4est_t * p4est,
 ...
 * \param filename      First part of the name, see p4est_vtk_ext_write_file.
 ...
 */
void                p4est_vtk_ext_write_all (p4est_t * p4est,
                                         p4est_geometry_t * geom,
                                         double scale,
 ...
 *
 * \begincode
 * p4est_vtk_ext_write_header(p4est, geom, 1., 1, 1, 0, "output");
 * p4est_vtk_ext_write_point_scalar (...);
 * ...
 * p4est_vtk_ext_write_footer(p4est, "output");
 * \endcode
 *
 ...
 */
int                 p4est_vtk_ext_write_header (p4est_t * p4est,
                                            p4est_geometry_t * geom,
                                            double scale,
                                            int write_tree, int write_level,
                                            int write_rank, int wrap_rank,
 ...
 * to \c p4est_vtk_ext_write_header.
 *
 * Writing a VTK file is split into a couple of routines.
 ...
 * \return          This returns 0 if no error and -1 if there is an error.
 */
int                 p4est_vtk_ext_write_point_scalar (p4est_t * p4est,
                                                  p4est_geometry_t * geom,
                                                  const char *filename,
 ...
 * \return          This returns 0 if no error and -1 if there is an error.
 */
int                 p4est_vtk_ext_write_point_vector (p4est_t * p4est,
                                                  p4est_geometry_t * geom,
                                                  const char *filename,
 ...
 *
 * \begincode
 * p4est_vtk_ext_write_header(p4est, ..., "output");
 * p4est_vtk_ext_write_footer(p4est, "output");
 * \endcode
 *
 * \param p4est     The p4est to be written.
 ...
 * \return          This returns 0 if no error and -1 if there is an error.
 */
int                 p4est_vtk_ext_write_footer (p4est_t * p4est,
                                            const char *filename);
