...
/*   d2xyz_drstdrst[0][0][0] = ((-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*(3*(-1 + c)*M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*pow(tan((a*M_PI)/4.),2)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.)) - 8*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2))/4.)*tan((a*M_PI)/4.)*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*M_PI*pow(tan((a*M_PI)/4.),2)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) + 2*M_PI*tan((a*M_PI)/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2)))/(16.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[0][1][0] = ((-1 + c)*M_PI*((-2 + c)*R0 + R1 - c*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*((-1 + c)*M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*(5 - 2*c + 3*a*(-2 + c)*tan((a*M_PI)/4.) - 2*(-1 + c)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*pow(tan((b*M_PI)/4.),2)) - 4*(-2 + c)*(5 - 2*c + (-1 + c)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*pow(tan((b*M_PI)/4.),2))))/(16.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[0][2][0] = (3*(-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)) - 2*(-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-a + tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-1 + c)*M_PI*(-R0 + R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 4*(-((-2 + c)*R0) + (-1 + c)*R1)*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2))/4.)*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) + 8*(-((-2 + c)*R0) + (-1 + c)*R1)*(-1 + (M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2))/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2) + 8*(-R0 + R1)*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2))/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][0][0] = -((-1 + c)*pow(M_PI,2)*((-2 + c)*R0 + R1 - c*R1)*(9 - 3*c + (13 - 7*c)*cos((b*M_PI)/2.) + cos((a*M_PI)/2.)*(-5 + 2*c + (-7 + 4*c)*cos((b*M_PI)/2.)))*pow(d4est_util_secant_fcn((a*M_PI)/4.),4)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*(b*(-2 + c) - (-1 + c)*tan((b*M_PI)/4.)))/(32.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][1][0] = ((-1 + c)*M_PI*((-2 + c)*R0 + R1 - c*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(((-1 + c)*M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*((7 - 4*c + 3*cos((b*M_PI)/2.))*pow(d4est_util_secant_fcn((b*M_PI)/4.),2) + 2*(-1 + c)*pow(tan((a*M_PI)/4.),2) + 6*b*(-2 + c)*tan((b*M_PI)/4.)))/2. - 4*(-2 + c)*(5 - 2*c + (-1 + c)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*pow(tan((b*M_PI)/4.),2))))/(16.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][2][0] = (M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(3*(-1 + c)*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)) - 2*(-1 + c)*(-((-2 + c)*R0) + (-1 + c)*R1)*(-b + tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-1 + c)*(-R0 + R1)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)))))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][0][0] = ((-1 + c)*pow(M_PI,2)*((-2 + c)*R0 + R1 - c*R1)*(9 - 3*c + (13 - 7*c)*cos((b*M_PI)/2.) + cos((a*M_PI)/2.)*(-5 + 2*c + (-7 + 4*c)*cos((b*M_PI)/2.)))*pow(d4est_util_secant_fcn((a*M_PI)/4.),4)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2))/(32.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][1][0] = (-3*pow(-1 + c,2)*pow(M_PI,2)*((-2 + c)*R0 + R1 - c*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((a*M_PI)/4.)*tan((b*M_PI)/4.))/(16.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][2][0] = (M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-2*(9 - 7*c + pow(c,2))*R0 + 2*(7 - 8*c + pow(c,2))*R1 + (-1 + c)*(c*(R0 - R1) + R1)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*(c*(R0 - R1) + R1)*pow(tan((b*M_PI)/4.),2)))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[0][0][1] = ((-1 + c)*M_PI*((-2 + c)*R0 + R1 - c*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*((-1 + c)*M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*(5 - 2*c + 3*a*(-2 + c)*tan((a*M_PI)/4.) - 2*(-1 + c)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*pow(tan((b*M_PI)/4.),2)) - 4*(-2 + c)*(5 - 2*c + (-1 + c)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*pow(tan((b*M_PI)/4.),2))))/(16.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[0][1][1] = -((-1 + c)*pow(M_PI,2)*((-2 + c)*R0 + R1 - c*R1)*(9 - 3*c + (-5 + 2*c)*cos((b*M_PI)/2.) + cos((a*M_PI)/2.)*(13 - 7*c + (-7 + 4*c)*cos((b*M_PI)/2.)))*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*pow(d4est_util_secant_fcn((b*M_PI)/4.),4)*(a*(-2 + c) - (-1 + c)*tan((a*M_PI)/4.)))/(32.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[0][2][1] = (M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(3*(-1 + c)*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)) - 2*(-1 + c)*(-((-2 + c)*R0) + (-1 + c)*R1)*(-a + tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-1 + c)*(-R0 + R1)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)))))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][0][1] = ((-1 + c)*M_PI*((-2 + c)*R0 + R1 - c*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(((-1 + c)*M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*((7 - 4*c + 3*cos((b*M_PI)/2.))*pow(d4est_util_secant_fcn((b*M_PI)/4.),2) + 2*(-1 + c)*pow(tan((a*M_PI)/4.),2) + 6*b*(-2 + c)*tan((b*M_PI)/4.)))/2. - 4*(-2 + c)*(5 - 2*c + (-1 + c)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*pow(tan((b*M_PI)/4.),2))))/(16.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][1][1] = ((-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*(3*(-1 + c)*M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*pow(tan((b*M_PI)/4.),2)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.)) - 8*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2))/4.)*tan((b*M_PI)/4.)*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*M_PI*pow(tan((b*M_PI)/4.),2)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) + 2*M_PI*tan((b*M_PI)/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2)))/(16.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][2][1] = (3*(-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)) - 2*(-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-b + tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-1 + c)*M_PI*(-R0 + R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 4*(-((-2 + c)*R0) + (-1 + c)*R1)*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2))/4.)*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) + 8*(-((-2 + c)*R0) + (-1 + c)*R1)*(-1 + (M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2))/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2) + 8*(-R0 + R1)*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2))/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][0][1] = (-3*pow(-1 + c,2)*pow(M_PI,2)*((-2 + c)*R0 + R1 - c*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((a*M_PI)/4.)*tan((b*M_PI)/4.))/(16.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][1][1] = ((-1 + c)*pow(M_PI,2)*((-2 + c)*R0 + R1 - c*R1)*(9 - 3*c + (-5 + 2*c)*cos((b*M_PI)/2.) + cos((a*M_PI)/2.)*(13 - 7*c + (-7 + 4*c)*cos((b*M_PI)/2.)))*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*pow(d4est_util_secant_fcn((b*M_PI)/4.),4))/(32.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][2][1] = (M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-2*(9 - 7*c + pow(c,2))*R0 + 2*(7 - 8*c + pow(c,2))*R1 + (-1 + c)*(c*(R0 - R1) + R1)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*(c*(R0 - R1) + R1)*pow(tan((b*M_PI)/4.),2)))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[0][0][2] = (3*(-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)) - 2*(-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-a + tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-1 + c)*M_PI*(-R0 + R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 4*(-((-2 + c)*R0) + (-1 + c)*R1)*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2))/4.)*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) + 8*(-((-2 + c)*R0) + (-1 + c)*R1)*(-1 + (M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2))/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2) + 8*(-R0 + R1)*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2))/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[0][1][2] = (M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(3*(-1 + c)*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)) - 2*(-1 + c)*(-((-2 + c)*R0) + (-1 + c)*R1)*(-a + tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-1 + c)*(-R0 + R1)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)))))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[0][2][2] = (3*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*pow(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2),2) - 4*(-((-2 + c)*R0) + (-1 + c)*R1)*(-a + tan((a*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 4*(-R0 + R1)*(-(a*(-2 + c)) + (-1 + c)*tan((a*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) + 8*(-R0 + R1)*(-a + tan((a*M_PI)/4.))*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2))/(4.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][0][2] = (M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(3*(-1 + c)*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)) - 2*(-1 + c)*(-((-2 + c)*R0) + (-1 + c)*R1)*(-b + tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-1 + c)*(-R0 + R1)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)))))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][1][2] = (3*(-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)) - 2*(-1 + c)*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-b + tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*(-1 + c)*M_PI*(-R0 + R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 2*M_PI*(-((-2 + c)*R0) + (-1 + c)*R1)*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 4*(-((-2 + c)*R0) + (-1 + c)*R1)*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2))/4.)*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) + 8*(-((-2 + c)*R0) + (-1 + c)*R1)*(-1 + (M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2))/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2) + 8*(-R0 + R1)*(2 - c + ((-1 + c)*M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2))/4.)*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[1][2][2] = (3*(-((-2 + c)*R0) + (-1 + c)*R1)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*pow(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2),2) - 4*(-((-2 + c)*R0) + (-1 + c)*R1)*(-b + tan((b*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) - 4*(-R0 + R1)*(-(b*(-2 + c)) + (-1 + c)*tan((b*M_PI)/4.))*(-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))) + 8*(-R0 + R1)*(-b + tan((b*M_PI)/4.))*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2))/(4.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][0][2] = (M_PI*pow(d4est_util_secant_fcn((a*M_PI)/4.),2)*tan((a*M_PI)/4.)*(-2*(9 - 7*c + pow(c,2))*R0 + 2*(7 - 8*c + pow(c,2))*R1 + (-1 + c)*(c*(R0 - R1) + R1)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*(c*(R0 - R1) + R1)*pow(tan((b*M_PI)/4.),2)))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][1][2] = (M_PI*pow(d4est_util_secant_fcn((b*M_PI)/4.),2)*tan((b*M_PI)/4.)*(-2*(9 - 7*c + pow(c,2))*R0 + 2*(7 - 8*c + pow(c,2))*R1 + (-1 + c)*(c*(R0 - R1) + R1)*pow(tan((a*M_PI)/4.),2) + (-1 + c)*(c*(R0 - R1) + R1)*pow(tan((b*M_PI)/4.),2)))/(8.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */

/* d2xyz_drstdrst[2][2][2] = ((-2 + pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2))*(8*R0 - 2*c*R0 - 14*R1 + 2*c*R1 + ((2 + c)*R0 + R1 - c*R1)*pow(tan((a*M_PI)/4.),2) + ((2 + c)*R0 + R1 - c*R1)*pow(tan((b*M_PI)/4.),2)))/(4.*pow(5 - 2*c + (-1 + c)*(pow(tan((a*M_PI)/4.),2) + pow(tan((b*M_PI)/4.),2)),2.5)); */


/*  for (int d1 = 0; d1 < (P4EST_DIM); d1++){ */
/*     for (int d2 = 0; d2 < (P4EST_DIM); d2++){ */
/*       for (int d3 = 0; d3 < (P4EST_DIM); d3++){ */
/*         d2xyz_drstdrst[d1][d2][d3] = dabc_drst[d2]*dabc_drst[d3]*d2xyz_drstdrst[d1][d2][d3]; */
/*       } */
/*     } */
/*  } */
...
d2xyz_drstdrst[1][2][2] = (pow(cmax - cmin,2)*(3*(R0*(-4 + cmax + cmin + cmax*t - cmin*t) - R1*(-2 + cmax + cmin + cmax*t - cmin*t))*((bmax + bmin + bmax*s - bmin*s)*(-4 + cmax + cmin + cmax*t - cmin*t) - 2*(-2 + cmax + cmin + cmax*t - cmin*t)*tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.))*pow(-2 + pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2),2) + 8*(-(R0*(-4 + cmax + cmin + cmax*t - cmin*t)) + R1*(-2 + cmax + cmin + cmax*t - cmin*t))*(bmax + bmin + bmax*s - bmin*s - 2*tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.))*(-2 + pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2))*(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.) + 32*(R0 - R1)*(-((bmax + bmin + bmax*s - bmin*s)*(-4 + cmax + cmin + cmax*t - cmin*t))/4. + ((-2 + cmax + cmin + cmax*t - cmin*t)*tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.))/2.)*(-2 + pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2))*(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.) + 32*(R0 - R1)*(bmax + bmin + bmax*s - bmin*s - 2*tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.))*pow(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.,2)))/(128.*pow(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.,2.5));

d2xyz_drstdrst[2][0][2] = ((amax - amin)*(cmax - cmin)*M_PI*pow(d4est_util_secant_fcn((M_PI*(amax + amin + amax*r - amin*r))/8.),2)*tan((M_PI*(amax + amin + amax*r - amin*r))/8.)*(-3*(-2 + cmax + cmin + cmax*t - cmin*t)*(R0*(-4 + cmax + cmin + cmax*t - cmin*t) - R1*(-2 + cmax + cmin + cmax*t - cmin*t))*(-2 + pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)) - 4*(R0 - R1)*(2 + cmin*(-1 + t) - cmax*(1 + t))*(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.) - 4*(-(R0*(-4 + cmax + cmin + cmax*t - cmin*t)) + R1*(-2 + cmax + cmin + cmax*t - cmin*t))*(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.)))/(128.*pow(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.,2.5));

d2xyz_drstdrst[2][1][2] = ((bmax - bmin)*(cmax - cmin)*M_PI*pow(d4est_util_secant_fcn((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)*tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.)*(-3*(-2 + cmax + cmin + cmax*t - cmin*t)*(R0*(-4 + cmax + cmin + cmax*t - cmin*t) - R1*(-2 + cmax + cmin + cmax*t - cmin*t))*(-2 + pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)) - 4*(R0 - R1)*(2 + cmin*(-1 + t) - cmax*(1 + t))*(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.) - 4*(-(R0*(-4 + cmax + cmin + cmax*t - cmin*t)) + R1*(-2 + cmax + cmin + cmax*t - cmin*t))*(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.)))/(128.*pow(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.,2.5));

d2xyz_drstdrst[2][2][2] = -(pow(cmax - cmin,2)*(-2 + pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2))*(3*(R0*(-4 + cmax + cmin + cmax*t - cmin*t) - R1*(-2 + cmax + cmin + cmax*t - cmin*t))*(-2 + pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)) - 8*(R0 - R1)*(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.)))/(32.*pow(5 + cmin*(-1 + t) - cmax*(1 + t) + ((-2 + cmax + cmin + cmax*t - cmin*t)*(pow(tan((M_PI*(amax + amin + amax*r - amin*r))/8.),2) + pow(tan((M_PI*(bmax + bmin + bmax*s - bmin*s))/8.),2)))/2.,2.5));
