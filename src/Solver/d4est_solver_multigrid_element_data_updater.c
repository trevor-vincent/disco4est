...
d4est_solver_multigrid_element_data_updater_init
(
 int num_of_levels,
...
{
  d4est_solver_multigrid_element_data_updater_t* updater = P4EST_ALLOC(d4est_solver_multigrid_element_data_updater_t,1);
  updater->update = d4est_solver_multigrid_element_data_updater_update;
...
void
d4est_solver_multigrid_element_data_updater_destroy
(
 d4est_solver_multigrid_element_data_updater_t* updater,
 int num_of_levels
)
{
