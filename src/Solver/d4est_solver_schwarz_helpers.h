...
void d4est_solver_schwarz_compute_and_add_correction_version2(p4est_t *p4est,d4est_geometry_t *d4est_geom,d4est_quadrature_t *d4est_quad,d4est_mesh_data_t *d4est_factors,d4est_ghost_t *ghost,d4est_ghost_data_t *ghost_data,d4est_solver_schwarz_metadata_t *schwarz_data,d4est_solver_schwarz_operators_t *schwarz_ops,d4est_laplacian_flux_data_t *flux_fcn_data,double *u,double *r);
double d4est_solver_schwarz_cg_solve_subdomain_single_core_version2(p4est_t *p4est,d4est_geometry_t *d4est_geom,d4est_quadrature_t *d4est_quad,d4est_mesh_data_t *d4est_factors,d4est_ghost_t *ghost,d4est_ghost_data_t *ghost_data,d4est_solver_schwarz_metadata_t *schwarz_data,d4est_solver_schwarz_operators_t *schwarz_ops,d4est_laplacian_flux_data_t *flux_fcn_data,double *du_restricted_field_over_subdomain,double *rhs_restricted_field_over_subdomain,int iter,double atol,double rtol,int subdomain);
...
int d4est_solver_schwarz_is_element_in_subdomain(d4est_solver_schwarz_subdomain_metadata_t *sub_data,int element_tree,int element_tree_quadid);
