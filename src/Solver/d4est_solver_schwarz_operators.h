...
void d4est_operators_apply_schwarz_weights(d4est_solver_schwarz_operators_t *d4est_schwarz_ops,double *in,int dim,int *faces,int deg,int restricted_size,double *out);
void d4est_operators_apply_schwarz_restrictor(d4est_solver_schwarz_operators_t *d4est_schwarz_ops,double *in,int dim,int *faces,int deg,int restricted_size,d4est_ops_transpose_t transpose,double *out);
