...
)
{
  ...
  for (int s = 0; s < schwarz_metadata->num_subdomains; s++){
    ...
    d4est_element_data_t* ed = NULL;
    int is_ghost = (sub_data->element_metadata[i].mpirank != p4est->mpirank);
    
    if (is_ghost){
      ed = d4est_element_data_get_ptr
           (
            p4est,
      ...
      ed = &d4est_ghost->ghost_elements[sub_data->element_metadata[i].id];
    }
      ...
      for (int f = 0; f < (P4EST_FACES); f++){        
        ...
        if(!is_ghost){      
          ...
          mortar_side_data = &d4est_factors->mortar_side_data[mortar_side_id_m];
        }
        else{
          mortar_side_data =
            ...
            (
             ...
             0,
             schwarz_data->mortar_side_ghost_data
            );
  ...
  for (int i = 0; i < sub_data->num_elements; i++){
    ...
    for (int f = 0; f < (P4EST_FACES); f++){
      ...
      if(!is_ghost){      
        ...
        flux_fcn_data->hm_mortar_quad = schwarz_mortar_data->hm_mortar_quad;
        flux_fcn_data->hp_mortar_quad = schwarz_mortar_data->hp_mortar_quad;
        flux_fcn_data->sj_m_mortar_quad = schwarz_mortar_data->sj_m_mortar_quad;
        flux_fcn_data->n_m_mortar_quad = schwarz_mortar_data->n_m_mortar_quad;
        flux_fcn_data->xyz_m_mortar_quad = schwarz_mortar_data->xyz_m_mortar_quad;
        flux_fcn_data->xyz_m_mortar_lobatto = schwarz_mortar_data->xyz_m_mortar_lobatto;
        flux_fcn_data->drst_dxyz_m_mortar_quad = schwarz_mortar_data->drst_dxyz_m_mortar_quad;
