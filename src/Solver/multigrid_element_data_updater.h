...
multigrid_element_data_updater_t *multigrid_element_data_updater_init(int num_of_levels,d4est_ghost_t *d4est_ghost_toplevel,d4est_ghost_data_t *d4est_ghost_data_toplevel,d4est_mesh_data_t *d4est_mesh_data_toplevel,void(*element_data_init_user_fcn)(d4est_element_data_t *,void *),d4est_mesh_initial_extents_t *initial_extents);
