#ifndef POISSON_LORENTZIAN_FCNS_WITH_OPT_H
#define POISSON_LORENTZIAN_FCNS_WITH_OPT_H 
...
typedef struct {
  ...
  d4est_laplacian_with_opt_flux_data_t* flux_data_for_apply_lhs;
  d4est_laplacian_with_opt_flux_data_t* flux_data_for_build_rhs;
...
)
{
  ...
  d4est_laplacian_with_opt_flux_data_t* flux_fcn_data = ctx->flux_data_for_apply_lhs;
  d4est_laplacian_with_opt_apply_aij(p4est, ghost, ghost_data, prob_vecs, flux_fcn_data, d4est_ops, d4est_geom, d4est_quad, d4est_factors,0);
}
...
{
  problem_ctx_t* ctx = user;
  d4est_laplacian_with_opt_flux_data_t* flux_fcn_data = ctx->flux_data_for_build_rhs;
  d4est_laplacian_with_opt_apply_aij(p4est, ghost, ghost_data, prob_vecs, flux_fcn_data, d4est_ops, d4est_geom, d4est_quad, d4est_factors,0);
}
