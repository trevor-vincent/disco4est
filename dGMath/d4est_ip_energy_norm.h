...
double d4est_ip_energy_norm_compute(p4est_t *p4est,double *u,d4est_ip_energy_norm_data_t *energy_norm_data,p4est_ghost_t *ghost,d4est_element_data_t *ghost_data,d4est_operators_t *d4est_ops,d4est_geometry_t *d4est_geom,d4est_quadrature_t *d4est_quad);
