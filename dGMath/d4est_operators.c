...
)
{
  ...
  d4est_linalg_invert_and_copy(GaussVij, ref_invGaussVij_1d, Gauss_degree + 1);
}
...
)
{
  ...
  d4est_linalg_mat_multiply(ref_GaussVij, invVij, ref_GLL_to_GL_interp_1d, Gauss_degree + 1, Lobatto_degree + 1, Lobatto_degree + 1);

  P4EST_FREE(ref_GaussVij);
}

void d4est_operators_build_custom_GLL_interp_1d
(
 d4est_operators_t* d4est_ops,
 double* custom_GLL_interp_1d,
 int Lobatto_degree,
 int custom_degree,
...
)
{
  ...
  double* invVij = d4est_operators_fetch_invVij_1d(d4est_ops, Lobatto_degree);
  d4est_linalg_mat_multiply(customVij, invVij, custom_GLL_interp_1d, custom_degree + 1, Lobatto_degree + 1, Lobatto_degree + 1);
...
/*   d4est_linalg_mat_multiply(ref_LobattoVij, invGaussVij, ref_GL_to_GLL_interp_1d, Lobatto_degree + 1, Gauss_degree + 1, Gauss_degree + 1); */
...
)
{
  ...
  d4est_linalg_leftinverse(ref_GLL_to_GL_interp_1d, ref_GLL_to_GL_interp_1d_inverse, Gauss_degree + 1, Lobatto_degree + 1);  
}
...
/*   d4est_linalg_mat_transpose_nonsqr(ref_GL_to_GLL_interp_1d, ref_GL_to_GLL_interp_trans_1d, Lobatto_degree + 1, Gauss_degree + 1); */
/* } */
...
{
  double* ref_GLL_to_GL_interp_1d = d4est_operators_fetch_ref_GLL_to_GL_interp_1d(d4est_ops, Lobatto_degree, Gauss_degree);
  d4est_linalg_mat_transpose_nonsqr(ref_GLL_to_GL_interp_1d, ref_GLL_to_GL_interp_trans_1d, Gauss_degree + 1, Lobatto_degree + 1);
}
...
/*   d4est_linalg_leftinverse(ref_GLL_to_GL_interp_trans_1d, ref_GLL_to_GL_interp_trans_1d_inverse, Lobatto_degree + 1, Gauss_degree + 1); */
/* } */
...
/*   if (dim == 1){ */
/*     d4est_linalg_matvec_plus_vec(1.0, GLL_to_GL_interp, u_Lobatto_in, 0., u_Gauss_out, nodes_Gauss, nodes_Lobatto); */
/*   } */
/*   else if (dim == 2) { */
/*     d4est_linalg_kron_A1A2x_nonsqr(u_Gauss_out, GLL_to_GL_interp, GLL_to_GL_interp, u_Lobatto_in, nodes_Gauss, nodes_Lobatto, */
/*                              nodes_Gauss, nodes_Lobatto); */
/*   } */
/*   else if (dim == 3){ */
/*     d4est_linalg_kron_A1A2A3x_nonsqr(u_Gauss_out, GLL_to_GL_interp, GLL_to_GL_interp, GLL_to_GL_interp, u_Lobatto_in, */
...
/* /\*   if (dim == 1){ *\/ */
/* /\*     d4est_linalg_matvec_plus_vec(1.0, GL_to_GLL_interp, u_Gauss_in, 0., u_Lobatto_out, nodes_Lobatto, nodes_Gauss); *\/ */
/* /\*   } *\/ */
/* /\*   else if (dim == 2) { *\/ */
/* /\*     d4est_linalg_kron_A1A2x_nonsqr(u_Lobatto_out, GL_to_GLL_interp, GL_to_GLL_interp, u_Gauss_in, nodes_Lobatto, nodes_Gauss, *\/ */
/* /\*                              nodes_Lobatto, nodes_Gauss); *\/ */
/* /\*   } *\/ */
/* /\*   else if (dim == 3){ *\/ */
/* /\*     d4est_linalg_kron_A1A2A3x_nonsqr(u_Lobatto_out, GL_to_GLL_interp, GL_to_GLL_interp, GL_to_GLL_interp, u_Gauss_in, *\/ */
...
/*   if (dim == 1){ */
/*     d4est_linalg_kron_vec_dot_xy(quad_weights, jac_quad, in_quad, nodes_quad, w_j_in_quad); */
/*     d4est_linalg_matvec_plus_vec(1.0, interp_trans, w_j_in_quad, 0., out, nodes_lobatto, nodes_quad); */
/*   } */
/*   else if (dim == 2) { */
/*     d4est_linalg_kron_vec_o_vec_dot_xy(quad_weights, jac_quad, in_quad, nodes_quad, w_j_in_quad); */
/*     d4est_linalg_kron_A1A2x_nonsqr(out, interp_trans, interp_trans, w_j_in_quad, nodes_lobatto, nodes_quad, */
/*                              nodes_lobatto, nodes_quad); */
/*   } else if (dim == 3) { */
/*     d4est_linalg_kron_vec_o_vec_o_vec_dot_xy(quad_weights, jac_quad, in_quad, nodes_quad, w_j_in_quad); */
/*     d4est_linalg_kron_A1A2A3x_nonsqr(out, interp_trans, interp_trans, interp_trans, w_j_in_quad, */
...
/*         if (dim == 3) { */
/*           d4est_linalg_kron_vec_o_vec_o_vec_dot_wxyz(quad_weights, jac_quad, rst_xyz[l][k], rst_xyz[lp][k], V_Dl_in, nodes_quad, W_V_Dl_in); */
/*           d4est_linalg_kron_A1A2A3x_nonsqr(VT_W_V_Dl_in, interp_trans, interp_trans, interp_trans, W_V_Dl_in, */
/*                                      nodes_lobatto, nodes_quad, nodes_lobatto, nodes_quad, nodes_lobatto, nodes_quad); */
/*         } */
/*         else if (dim == 2) { */
/*           d4est_linalg_kron_vec_o_vec_dot_wxyz(quad_weights, jac_quad, rst_xyz[l][k], rst_xyz[lp][k], V_Dl_in, nodes_quad, W_V_Dl_in); */
/*           d4est_linalg_kron_A1A2x_nonsqr(VT_W_V_Dl_in, interp_trans, interp_trans, W_V_Dl_in, nodes_lobatto, nodes_quad, */
/*                                    nodes_lobatto, nodes_quad); */
/*         } */
/*         else if (dim == 1){ */
/*           d4est_linalg_kron_vec_dot_wxyz(quad_weights, jac_quad, V_Dl_in, rst_xyz[l][k], rst_xyz[lp][k], nodes_quad, W_V_Dl_in); */
/*           d4est_linalg_matvec_plus_vec(1.0, interp_trans, W_V_Dl_in, 0., VT_W_V_Dl_in, nodes_lobatto, nodes_quad); */
/*         } */
...
/*               d4est_linalg_kron_vec1_o_vec2_o_vec3_dot_wxyz(quad_weights[2],quad_weights[1],quad_weights[0], jac_quad, rst_xyz[l][k], rst_xyz[lp][k], V_Dl_in, nodes_quad, W_V_Dl_in); */
...
/*           d4est_linalg_kron_vec1_o_vec2_dot_wxyz(quad_weights[1], quad_weights[0], jac_quad, rst_xyz[l][k], rst_xyz[lp][k], V_Dl_in, nodes_quad, W_V_Dl_in); */
...
/*         } */
/*         else if (dim == 1){ */
/*           d4est_linalg_matvec_plus_vec(1.0, interp_lobatto_to_quad[0], Dl_in, 0.,  V_Dl_in, nodes_quad, nodes_lobatto); */
/*           d4est_linalg_kron_vec_dot_wxyz(quad_weights[0], jac_quad, V_Dl_in, rst_xyz[l][k], rst_xyz[lp][k], nodes_quad, W_V_Dl_in); */
/*           d4est_linalg_matvec_plus_vec(1.0, interp_lobatto_to_quad_trans[0], W_V_Dl_in, 0., VT_W_V_Dl_in, nodes_lobatto, nodes_quad); */
/*         } */
...
/* /\*           d4est_linalg_kron_A1A2A3x_nonsqr(VT_W_V_Dl_in, GLL_to_GL_interp_trans, GLL_to_GL_interp_trans, GLL_to_GL_interp_trans, W_V_Dl_in, *\/ */
/* /\*                                      nodes_Lobatto, nodes_Gauss, nodes_Lobatto, nodes_Gauss, nodes_Lobatto, nodes_Gauss); *\/ */
/* /\*         } *\/ */
/* /\*         else if (dim == 2) { *\/ */
/* /\*           d4est_linalg_kron_vec_o_vec_dot_xy(Gauss_weights, Jdrdxdrdx[l][lp], V_Dl_in, nodes_Gauss, W_V_Dl_in); *\/ */
/* /\*           d4est_linalg_kron_A1A2x_nonsqr(VT_W_V_Dl_in, GLL_to_GL_interp_trans, GLL_to_GL_interp_trans, W_V_Dl_in, nodes_Lobatto, nodes_Gauss, *\/ */
/* /\*                                    nodes_Lobatto, nodes_Gauss); *\/ */
/* /\*         } *\/ */
/* /\*         else if (dim == 1){ *\/ */
/* /\*           d4est_linalg_kron_vec_dot_xy(Gauss_weights, Jdrdxdrdx[l][lp], V_Dl_in, nodes_Gauss, W_V_Dl_in); *\/ */
/* /\*           d4est_linalg_matvec_plus_vec(1.0, GLL_to_GL_interp_trans, W_V_Dl_in, 0., VT_W_V_Dl_in, nodes_Lobatto, nodes_Gauss); *\/ */
/* /\*         } *\/ */
...
/*   if (dim == 1){ */
/*     d4est_linalg_matvec_plus_vec(1.0, invVij, u_Lobatto_in, 0., temp, nodes_Lobatto, nodes_Lobatto); */
/*     d4est_linalg_matvec_plus_vec(1.0, GaussVij, temp, 0., u_Gauss_out, nodes_Gauss, nodes_Lobatto); */
/*   } */
/*   else if (dim == 2) { */
/*     d4est_linalg_kron_A1A2x_nonsqr(temp, invVij, invVij, u_Lobatto_in, nodes_Lobatto, nodes_Lobatto, */
/*                              nodes_Lobatto, nodes_Lobatto);     */
/*     d4est_linalg_kron_A1A2x_nonsqr(u_Gauss_out, GaussVij, GaussVij, temp, nodes_Gauss, nodes_Lobatto, */
/*                              nodes_Gauss, nodes_Lobatto); */
/*   } */
/*   else if (dim == 3){ */
/*     d4est_linalg_kron_A1A2A3x_nonsqr(temp, invVij, invVij, invVij, u_Lobatto_in, */
/*                                nodes_Lobatto, nodes_Lobatto, nodes_Lobatto, nodes_Lobatto, nodes_Lobatto, nodes_Lobatto); */
/*     d4est_linalg_kron_A1A2A3x_nonsqr(u_Gauss_out, GaussVij, GaussVij, GaussVij, temp, */
/*                                nodes_Gauss, nodes_Lobatto, nodes_Gauss, nodes_Lobatto, nodes_Gauss, nodes_Lobatto); */
/*   } */
/*   else { */
/*     P4EST_FREE(temp); */
...
void d4est_operators_apply_Mij(d4est_operators_t* d4est_ops, double* in, int dim, int deg,
  ...
  int nodes = deg + 1;
  if (dim == 1)
    d4est_linalg_matvec_plus_vec(1.0, mass_ref_1d, in, 0., out, nodes, nodes);
  else if (dim == 2) {
    /* d4est_linalg_kron_A1A2x_SQR(out, mass_ref_1d, mass_ref_1d, in, nodes, nodes);
     */
    d4est_linalg_kron_A1A2x_nonsqr(out, mass_ref_1d, mass_ref_1d, in, nodes, nodes,
                             nodes, nodes);
  } else if (dim == 3) {
    /* d4est_linalg_kron_A1A2A3x_SQR(out, mass_ref_1d, mass_ref_1d, mass_ref_1d, in,
     * nodes, nodes, nodes); */
    d4est_linalg_kron_A1A2A3x_nonsqr(out, mass_ref_1d, mass_ref_1d, mass_ref_1d, in,
...
void d4est_operators_apply_invMij(d4est_operators_t* d4est_ops, double* in, int dim,
  ...
  int nodes = deg + 1;
  if (dim == 1)
    d4est_linalg_matvec_plus_vec(1.0, inv_mass_ref_1d, in, 0., out, nodes, nodes);
  else if (dim == 2) {
    d4est_linalg_kron_A1A2x_nonsqr(out, inv_mass_ref_1d, inv_mass_ref_1d, in, nodes,
                             nodes, nodes, nodes);
  } else if (dim == 3) {
    d4est_linalg_kron_A1A2A3x_nonsqr(out, inv_mass_ref_1d, inv_mass_ref_1d,
...
#if ORDERING == 1
    if (dir == 0) d4est_linalg_kron_MAToIx_SQR(out, Dr_1d_transpose, in, nodes);
    if (dir == 1) d4est_linalg_kron_IoMATx_SQR(out, Dr_1d_transpose, in, nodes);
    /* mpi_abort("ORDERING == 1"); */
#endif
#if ORDERING == 3
...
#if ORDERING == 1
    if (dir == 0) d4est_linalg_kron_MAToIoIx_SQR(out, Dr_1d_transpose, in, nodes);
    if (dir == 1) d4est_linalg_kron_IoMAToIx_SQR(out, Dr_1d_transpose, in, nodes);
    if (dir == 2) d4est_linalg_kron_IoIoMATx_SQR(out, Dr_1d_transpose, in, nodes);
    /* mpi_abort("Ordering == 1"); */
#endif
#if ORDERING == 2
    /* if (dir == 0) d4est_linalg_kron_IoMAToIx_SQR(out, Dr_1d_transpose, in, nodes); */
    /* if (dir == 1) d4est_linalg_kron_IoIoMATx_SQR(out, Dr_1d_transpose, in, nodes); */
...
void d4est_operators_apply_p_prolong(d4est_operators_t* d4est_ops, double* in, int degH,
  ...
  if (degh == degH) {
    d4est_linalg_copy_1st_to_2nd(in, out, d4est_operators_get_nodes(dim, degh));
    return;
  }
...
void d4est_operators_apply_slicer(d4est_operators_t* d4est_ops, double* in, int dim,
  ...
  if (dir == 0)
    ...
    d4est_linalg_kron_IoVEC_TRANSoIx_SQR(out, &slicer_1d[side * (deg + 1)], in,
                                   deg + 1);
  else if (dir == 2)
    d4est_linalg_kron_IoIoVEC_TRANSx_SQR(out, &slicer_1d[side * (deg + 1)], in,
                                   deg + 1);
  else
...
#if (ORDERING)==1
    if (dir == 0) d4est_linalg_kron_MAToIx_SQR(out, flip_1d, in, nodes);
    if (dir == 1) d4est_linalg_kron_IoMATx_SQR(out, flip_1d, in, nodes);
    /* mpi_abort("ORDERING==1"); */
#endif
#if (ORDERING)==3
