...
)
{
  ...
  d4est_elliptic_data_t prob_vecs_jac;
  d4est_elliptic_data_t prob_vecs_F_u0;
  d4est_elliptic_data_t prob_vecs_F_u0_p_u;
  d4est_elliptic_data_copy_ptrs(prob_vecs,&prob_vecs_jac);
  d4est_elliptic_data_copy_ptrs(prob_vecs,&prob_vecs_F_u0);
  d4est_elliptic_data_copy_ptrs(prob_vecs,&prob_vecs_F_u0_p_u);
