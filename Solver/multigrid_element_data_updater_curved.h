...
multigrid_element_data_updater_t *multigrid_element_data_updater_curved_init(int num_of_levels,p4est_ghost_t **ghost,d4est_element_data_t **ghost_data,d4est_geometry_storage_t *d4est_geometry_storage_toplevel,d4est_geometry_t *d4est_geom,void(*element_data_init_user_fcn)(void *,void *),void *user);
