...
multigrid_element_data_updater_t *multigrid_element_data_updater_init(int num_of_levels,p4est_ghost_t **ghost,d4est_element_data_t **ghost_data,d4est_mesh_geometry_storage_t *d4est_mesh_geometry_storage_toplevel,void(*element_data_init_user_fcn)(d4est_element_data_t *,void *),void *user);
