...
)
{
  ...
  /* d4est_element_data_init_node_vec(p4est, u_analytic, analytic_fcn, d4est_ops); */
  ...
  /* printf("Number of elements = %d\n", p4est->local_num_quadrants); */
    /* d4est_element_data_print_element_data_debug(p4est); */
  ...
  d4est_element_data_init_node_vec(p4est, u_analytic, analytic_fcn, d4est_ops, d4est_geom->p4est_geom);
