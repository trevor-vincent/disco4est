...
void d4est_geometry_cubed_sphere_outer_shell_block_get_custom_quadrature(d4est_geometry_t *d4est_geom,p4est_topidx_t which_tree,p4est_qcoord_t q0[3],p4est_qcoord_t dq,int degree,double *custom_abscissas_dbl,double *custom_weights_dbl,int test_moments);
