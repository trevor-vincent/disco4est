...
smooth_pred_marker_t hp_amr_curved_smooth_pred_get_sigaverage_marker(double *sigma);
smooth_pred_marker_t hp_amr_curved_smooth_pred_get_NULL_marker();
smooth_pred_marker_t hp_amr_curved_smooth_pred_get_percentile_marker(int *percentile);
void hp_amr_curved_smooth_pred_set_gammah(hp_amr_scheme_t *scheme,double gamma_h);
void hp_amr_curved_smooth_pred_set_marker(hp_amr_scheme_t *scheme,smooth_pred_marker_t marker);
