...
typedef enum {D4EST_VTK_ASCII, D4EST_VTK_BINARY, D4EST_VTK_ZLIB_BINARY} d4est_vtk_output_type_t;
...
d4est_vtk_context_t *d4est_vtk_write_element_data(d4est_vtk_context_t *cont,int write_tree,int write_level,int write_rank,int wrap_rank,int write_deg,int num_element_fields,const char **names,double **values,d4est_vtk_output_type_t output_type);
d4est_vtk_context_t *d4est_vtk_write_data(d4est_vtk_context_t *cont,int num_point_scalars,const char **names,double **values,d4est_vtk_grid_type_t grid_type,d4est_vtk_output_type_t output_type);
...
d4est_vtk_context_t *d4est_vtk_write_point_scalar(d4est_vtk_context_t *cont,const char *scalar_name,double *values,d4est_vtk_grid_type_t grid_type,d4est_vtk_output_type_t output_type);
...
d4est_vtk_context_t *d4est_vtk_write_cell_scalar(d4est_vtk_context_t *cont,const char *scalar_name,double *values,d4est_vtk_output_type_t output_type);
d4est_vtk_context_t *d4est_vtk_write_header(d4est_vtk_context_t *cont,d4est_operators_t *d4est_ops,d4est_vtk_output_type_t output_type);
...
const char *d4est_vtk_get_format_string(d4est_vtk_output_type_t output_type);
