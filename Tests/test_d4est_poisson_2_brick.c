...
)
{
  ...
  /* printf("mortar_side_id_m = %d, mortar_side_id_p = %d\n", mortar_side_id_m, mortar_side_id_p); */
  /* int stride = 0; */
  ...
  /*         printf("DT_lifted_proj_VT_w_term2_mortar_lobatto[%d][%d] = %.25f\n", d, i, */
  /*                DT_lifted_proj_VT_w_term2_mortar_lobatto[d][i + stride]); */
  /*       } */
  /*       printf("lifted_proj_VT_w_term3_mortar_lobatto[%d] = %f\n",i, lifted_proj_VT_w_term3_mortar_lobatto[i + stride]); */
  /*       printf("lifted_proj_VT_w_term1_mortar_lobatto[%d] = %f\n",i, lifted_proj_VT_w_term1_mortar_lobatto[i + stride]); */
  /*     } */
  /*   } */
...
)
{
  ...
  d4est_poisson_flux_data->interface_fcn = test_d4est_poisson_2_brick_interface;
