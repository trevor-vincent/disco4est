#ifndef HACKED_P4EST_VTK_H
#define HACKED_P4EST_VTK_H 
 ...
 */
void                hacked_p4est_vtk_write_file (p4est_t * p4est,
 ...
 * \param filename      First part of the name, see hacked_p4est_vtk_write_file.
 ...
 */
void                hacked_p4est_vtk_write_all (p4est_t * p4est,
                                         p4est_geometry_t * geom,
                                         double scale,
 ...
 *
 * \begincode
 * hacked_p4est_vtk_write_header(p4est, geom, 1., 1, 1, 0, "output");
 * hacked_p4est_vtk_write_point_scalar (...);
 * ...
 * hacked_p4est_vtk_write_footer(p4est, "output");
 * \endcode
 *
 ...
 */
int                 hacked_p4est_vtk_write_header (p4est_t * p4est,
                                            p4est_geometry_t * geom,
                                            double scale,
                                            int write_tree, int write_level,
                                            int write_rank, int wrap_rank,
 ...
 * to \c hacked_p4est_vtk_write_header.
 *
 * Writing a VTK file is split into a couple of routines.
 ...
 * \return          This returns 0 if no error and -1 if there is an error.
 */
int                 hacked_p4est_vtk_write_point_scalar (p4est_t * p4est,
                                                  p4est_geometry_t * geom,
                                                  const char *filename,
 ...
 * \return          This returns 0 if no error and -1 if there is an error.
 */
int                 hacked_p4est_vtk_write_point_vector (p4est_t * p4est,
                                                  p4est_geometry_t * geom,
                                                  const char *filename,
 ...
 *
 * \begincode
 * hacked_p4est_vtk_write_header(p4est, ..., "output");
 * hacked_p4est_vtk_write_footer(p4est, "output");
 * \endcode
 *
 * \param p4est     The p4est to be written.
 ...
 * \return          This returns 0 if no error and -1 if there is an error.
 */
int                 hacked_p4est_vtk_write_footer (p4est_t * p4est,
                                            const char *filename);
